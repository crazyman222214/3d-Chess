...
This is the readme for 3D Chess, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. DChess) > Ok.
...
- To run the project find DChess.java (which will be in under src/main/java/edu/neumont/csc) and right click > Run 'DChess'
